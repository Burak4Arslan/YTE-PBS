...
export default function PersonelPage() {
    ...
    // Updated filters state (removed contribution)
    ...
    // Updated options state (removed contribution)
    ...
    // Updated fetch to pull only the 5 required filter options
    useEffect(() => {
    ...
    // Updated labels list (removed contribution / Katkı)
    const filterLabels = [
